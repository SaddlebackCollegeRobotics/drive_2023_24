...
class MotorController():
    ...
    def clear_errors(self, node_id) -> None:
        self._can_interface.send_function_call(node_id, 'clear_errors')
    
    def save_configuration(self, node_id) -> None:
        self._can_interface.send_function_call(node_id, 'save_configuration')

    def reboot(self, node_id) -> None:
        self._can_interface.send_function_call(node_id, 'reboot')
